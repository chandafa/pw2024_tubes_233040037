...
if (!isset($_SESSION['username'])) {
    // Jika tidak, alihkan ke halaman login atau halaman lainnya
    header('Location: login.php');
    exit;
}

// Dapatkan username pengguna yang login
...
if ($result) {
    ...
    // Misalnya, alihkan pengguna atau tampilkan pesan kesalahan
    header('Location: error.php');
    exit;
}

// Atur variabel $name dan $email setelah mendapatkan data dari database
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Update informasi pengguna dalam database
    ...
    if ($update_result) {
        ...
        // Handle kesalahan jika gagal mengupdate informasi pengguna
        $error_message = 'Gagal mengupdate informasi pengguna.';
    }
}
?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid m-2">
                    ...
                    <h1 class="mb-4">Profil Profile</h1>
                    <!-- Tampilkan informasi Profile -->
                    <p><strong></strong><img src=" <?php echo $foto; ?>"></p>
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="name" name="name" id="name" class="form-control shadow-none"
                                placeholder=" name">
                        </div>
                        <div class="mb-3">
