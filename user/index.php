...
<body>
    <nav class='navbar navbar-expand-lg navbar-dark bg-dark text-light '>
        <div class="container">
            <a href="../index.php" class="navbar-brand">Sport Zone</a>
            ...
            <ul class="navbar-nav ml-auto pt-2 pb-2">
                ...
                <li class="nav-item">
                    <a href="index.php" class="nav-link text-light">Lapangan</a>
                </li>
                <li class="nav-item">
                    <a href="index.php" class="nav-link text-light">Tagihan</a>
                </li>
